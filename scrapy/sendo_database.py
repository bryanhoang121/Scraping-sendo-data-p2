...
def insert_product_data(conn, products):
    """
    ...
    try:
        with conn.cursor() as cur:
            ...
            insert_query = '''INSERT INTO products (name, price_range, brand, sold, rating, rating_count, product_option, description, url) 
                              VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)'''
            cur.executemany(insert_query, product_tuples)
            conn.commit()
